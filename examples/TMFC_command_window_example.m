...
% The same whitening transform is applied to the seed signal and deconvolution matrix,
% consistent with SPM PEB assumptions. In subsequent gPPI model estimation, PHYS is derived
% from unwhitened and unfiltered BOLD data adjusted for regressors of no interest,
% avoiding double whitening (He et al., 2025).
